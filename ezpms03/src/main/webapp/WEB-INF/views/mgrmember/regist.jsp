...
<script>
	...
	function DupCheckID()
	{
		...
		$.ajax({
			type: "get",
			url : "${pageContext.request.contextPath}/login/idcheck.do?id=" + userid,
			dataType: "html",
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h4 class="m-0 font-weight-bold text-primary">교수 등록</h4>
			</div>
			<div class="card-body" style="padding: 100px 200px">
				<div class="table-responsive">	
					<form id="regist" name="regist" method="post" action="${pageContext.request.contextPath}/mgrmember/registok.do">
						...
						<div style="width:100%; text-align: center">
							<button type="button" class="btn btn-outline-primary mr-5" id="btnSubmit" style="width:150px">교수 등록</button>
