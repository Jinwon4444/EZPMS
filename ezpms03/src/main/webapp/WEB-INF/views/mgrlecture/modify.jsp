...
<script>
	...
	function DoCancle(lno)
	{
		...
		{
			document.location = "${pageContext.request.contextPath}/lecture/view.do?lno=" + lno;
		}
	}
...
<div class="w-100">
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<form id="modify" name="modify" action="${pageContext.request.contextPath}/mgrlecture/modifyok.do" method="post" enctype="multipart/form-data">
							...
							<tbody>
								...
								<tr>
									...
									<td style="width:40%" colspan="3">
										<span>${ item.name }</span> 
										<!-- 
										<button type="button" class="btn-sm ml-3" onclick="doChange()">교사 변경</button>
