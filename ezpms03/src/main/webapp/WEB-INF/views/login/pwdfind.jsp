...
function btnSubmit()
{
	...
	$.ajax({
		...
		success : function(data){
			...
			{	
				if(confirm("임시 비밀번호를 발급하시겠습니까?") == true)
				{
					$("#pwdfind").submit();
				...
				<!-- Nested Row within Card Body -->
					<div class="w-100">
						<div class="p-5">
							...
							<form class="user" id="pwdfind" method="post" action="${pageContext.request.contextPath}/login/pwdnew.do">
								<div class="form-group">
									<input type="text" class="form-control form-control-user" id="userid" name="userid" placeholder="ID">
								</div>
								<div class="form-group d-flex">
									<input type="text" name="email" class="form-control form-control-user w-75" id="email" placeholder="e-mail">
								...
								<a href="javascript:btnSubmit()" class="btn btn-primary btn-user btn-block">비밀번호 찾기</a>
